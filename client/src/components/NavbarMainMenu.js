...
export default () => {
  ...
  return (
    ...
    style={{ 
      ...
      {console.log(winner)}
        <div className="col-3" >
          <div className="card mb-3 p-3" style={{ height: '67%', marginTop: '8%'}}>
            <div className="row no-gutters">
              <div className="col-md-4">
                <img src={Gold} className="card-img" 
                style={{marginLeft:'31%', marginTop: '19%', height: '56%', width: '53%'}}/>
              </div>
              <div className="col-md-8 pt-3">
                <div className="card-body">
                  <h5 className="card-title"><b>#1</b> {winner[0].username} 
                  <br/> Score: <b>{winner[0].score}</b> </h5>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="col-3" >
          <div className="card mb-3 p-3" style={{ height: '67%', marginTop: '8%'}}>
            <div className="row no-gutters">
              <div className="col-md-4">
                <img src={Silver} className="card-img" 
                style={{marginLeft:'13%', marginTop: '16%', height: '64%', width: '72%' }}/>
              </div>
              <div className="col-md-8 pt-3">
                <div className="card-body">
                  <h5 className="card-title"><b>#2</b> {winner[1].username} 
                  <br/> Score: <b>{winner[1].score}</b></h5>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="col-3">
          <div className="card mb-3 p-3" style={{ height: '67%', marginTop: '8%'}}>
            <div className="row no-gutters">
              <div className="col-md-4">
                <img src={Bronze} className="card-img" 
                style={{marginLeft:'28%',marginTop: '19%', height: '59%', width: '53%'}}/>
              </div>
              <div className="col-md-8 pt-3">
                <div className="card-body">
                  <h5 className="card-title"><b>#3</b> {winner[2].username} 
                  <br/> Score: <b>{winner[2].score}</b></h5>
                </div>
              </div>
            </div>
          </div>
